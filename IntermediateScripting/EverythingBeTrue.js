...
// Boolean(obj[pre]): This part converts the value of the property pre to a boolean. It returns true if the value is truthy (not falsy), and false otherwise.

function truthCheck(collection, pre) {
    const result = collection.every((obj) => obj.hasOwnProperty(pre) && Boolean(obj[pre]));
    return result;
}
